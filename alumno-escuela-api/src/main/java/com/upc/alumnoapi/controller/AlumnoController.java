...
public class AlumnoController {
    ...
    @GetMapping("/dto/{id}")
    public ResponseEntity<AlumnoEscuelaDTO> getAlumnoEscuela (@PathVariable (value = "id") Long alumnoId) {
        return new ResponseEntity<AlumnoEscuelaDTO>(alumnoService.getAlumnoEscuela(alumnoId), HttpStatus.OK);
    }
